...
This is the cognitive toolsets for pydantic-ai

- **Github repository**: <https://github.com/cradiator/pydantic-ai-cognitive/>
- **Documentation** <https://cradiator.github.io/pydantic-ai-cognitive/>
...
git remote add origin git@github.com:cradiator/pydantic-ai-cognitive.git
...
- Add the API Token to your projects secrets with the name `PYPI_TOKEN` by visiting [this page](https://github.com/cradiator/pydantic-ai-cognitive/settings/secrets/actions/new).
- Create a [new release](https://github.com/cradiator/pydantic-ai-cognitive/releases/new) on Github.
